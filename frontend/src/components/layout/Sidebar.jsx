...
import { LayoutDashboard, Receipt, PieChart, TrendingUp, MessageSquareText, Wallet, LogOut } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: "/prediction", label: "Prediksi AI", icon: TrendingUp },
  { to: "/chat", label: "Chatbot Advisor", icon: MessageSquareText },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-white border-r border-[#dcd9d5] h-screen flex flex-col fixed left-0 top-0">
      <div className="p-5 flex items-center gap-2.5 border-b border-[#f3f0ec]">
